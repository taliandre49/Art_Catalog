...
<template class="parent">
    ...
    <!-- <BModal v-if="route.params.type === 'writings'" v-model="showModal" id="modal-scrollable" scrollable title="Comments" hide-footer>
        <span v-if="fixtures['content-material'][route.params.type][route.params.category][route.params.url].comments.length===0">No Comments</span>
        <BCard id="comment-sections" bg-variant="light" class="my-4" v-for="comment in fixtures['content-material'][route.params.type][route.params.category][route.params.url].comments" :key="comment">
            <p class="my-4">
